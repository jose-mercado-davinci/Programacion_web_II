...
<head>
  ...
  <title>Black Hole Studio - Historia</title>
      ...
      <div class="container d-flex align-items-center">
        <div class="row">
          <div class="col">
            ...
            <p class="lead">También iniciamos este camino en la música tocando la guitarra, la batería, etc. Conviviendo
              con cables y computadoras el aprendizaje técnico era necesario. Queremos ayudarte en tu camino hacia la
      ...
      <div class="container">
        <div class="row my-4">
          ...
          <div class="col-lg-6 py-4 my-lg-0 d-flex flex-column justify-content-between justify-content-lg-center">
            ...
            <p> Todo empezó en aquellos tiempos donde aún no existía plataformas de música, en donde la música se pasaba
              de pendrive en pendrive en formato mp3. Cuando dimos nuestros primeros pasos en la música no había tanto
              información como la hay ahora, y hemos recorrido un largo camino... Ahora queremos enseñarte lo que hemos
              aprendido</p>
          </div>
        </div>
      </div>
